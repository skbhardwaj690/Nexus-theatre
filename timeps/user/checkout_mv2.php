...
{
  header('location:/timeps/login.php');
}
...
<div id="mainContainer" class="row large-centered">
  ...
  <dl class="mercDetails">
    <dt>Merchant</dt>         <dd>NEXUS Theater</dd>
    <dt>Transaction Amount</dt>   <dd>INR <?php echo  $_SESSION['amt'];?></dd>
    <dt>Debit Card</dt>     <dd><?php echo  $cn;?></%></dd>
  </dl>
  <hr class="divider">
  
  
<form name="form1" id="form1" method="post" action="book.php">
...
<p class="form-subheading">OTP sent to your mobile number ending <strong><?php echo substr($pn, 6, 9) ?></strong></p>
</div>
...
<label>&nbsp;</label><input type="submit" class="expanded button next" name="make" value="Make Payment" onClick="ValidateForm()"/>
</div>
</div>
