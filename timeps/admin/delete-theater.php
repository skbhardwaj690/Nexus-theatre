...
<html>
	<head>
		<meta charset="utf-8">
		<title>Delete Theater Records</title>
		<link rel="stylesheet" href="css/style.css" />
	</head>
	...
	<body>
		<div class="form">
			...
			<table width="100%" border="1" style="border-collapse:collapse;">
				<thead>
					<tr><th><strong>S.No</strong></th><th><strong>Name</strong></th><th><strong>Address</strong></th><th><strong>State</strong></th><th><strong>City</strong></th><th><strong>Pin-code</strong></th><th><strong>Delete</strong></th></tr>
				</thead>
				<tbody>
					<?php
						$count=1;
					...
					?>
						<tr>
							...
							<td align="center"><a href="delete3.php?id=<?php echo $row["id"]; ?>"><img src="../upload/delete.png" width="25px" height="25px"></a></td>
						</tr>
						<?php 
							$count++; 
							} 
