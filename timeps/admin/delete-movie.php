	...
	<body>
		<div class="form">
			...
			<table width="100%" border="1" style="border-collapse:collapse;">
				<thead>
					<tr><th><strong>S.No</strong></th><th><strong>Movie-name</strong></th><th><strong>Language</strong></th><th><strong>Cast</strong></th><th><strong>Description</strong></th><th><strong>Release-year</strong></th><th><strong>Video-URL</strong></th><th><strong>Ticket-price</strong></th><th><strong>Screen-day</strong></th><th><strong>Screen-time</strong></th><th><strong>Image</strong></th><th><strong>Delete</strong></th></tr>
				</thead>
				<tbody>
					<?php
						$count=1;
					...
					?>
						<tr>
							...
							<td align="center"><a href="delete2.php?id=<?php echo $row["id"]; ?>"><img src="../upload/delete.png" width="25px" height="25px"></a></td>
						</tr>
						<?php 
							$count++; 
							} 
