...
<html>
	<head>
		<meta charset="utf-8">
		<title>View Theaters Records</title>
		<link rel="stylesheet" href="css/style.css" />
	</head>

	<body>
		<div class="form">
			<h2>View Theaters Records</h2>
			
			<table width="100%" border="1" style="border-collapse:collapse;">
				<thead>
					<tr><th><strong>S.No</strong></th><th><strong>Name</strong></th><th><strong>Address</strong></th><th><strong>State</strong></th><th><strong>City</strong></th><th><strong>Pin-code</strong></th></tr>
				</thead>
				<tbody>
					<?php
						$count=1;
